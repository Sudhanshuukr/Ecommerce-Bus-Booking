...
INSERT INTO bus_seats (id, bus_id, seat_label, deck, row, column, seat_type) VALUES
    ('bs-01-1A', 'b0000000-0000-0000-0000-000000000001', '1A', 'lower', 1, 1, 'seater'),
    ('bs-01-1B', 'b0000000-0000-0000-0000-000000000001', '1B', 'lower', 1, 2, 'seater'),
    ('bs-01-1C', 'b0000000-0000-0000-0000-000000000001', '1C', 'lower', 1, 4, 'seater'),
    ('bs-01-1D', 'b0000000-0000-0000-0000-000000000001', '1D', 'lower', 1, 5, 'seater'),

    ('bs-01-2A', 'b0000000-0000-0000-0000-000000000001', '2A', 'lower', 2, 1, 'seater'),
    ('bs-01-2B', 'b0000000-0000-0000-0000-000000000001', '2B', 'lower', 2, 2, 'seater'),
    ('bs-01-2C', 'b0000000-0000-0000-0000-000000000001', '2C', 'lower', 2, 4, 'seater'),
    ('bs-01-2D', 'b0000000-0000-0000-0000-000000000001', '2D', 'lower', 2, 5, 'seater'),

    ('bs-01-3A', 'b0000000-0000-0000-0000-000000000001', '3A', 'lower', 3, 1, 'seater'),
    ('bs-01-3B', 'b0000000-0000-0000-0000-000000000001', '3B', 'lower', 3, 2, 'seater'),
    ('bs-01-3C', 'b0000000-0000-0000-0000-000000000001', '3C', 'lower', 3, 4, 'seater'),
    ('bs-01-3D', 'b0000000-0000-0000-0000-000000000001', '3D', 'lower', 3, 5, 'seater'),

    ('bs-01-4A', 'b0000000-0000-0000-0000-000000000001', '4A', 'lower', 4, 1, 'seater'),
    ('bs-01-4B', 'b0000000-0000-0000-0000-000000000001', '4B', 'lower', 4, 2, 'seater'),
    ('bs-01-4C', 'b0000000-0000-0000-0000-000000000001', '4C', 'lower', 4, 4, 'seater'),
    ('bs-01-4D', 'b0000000-0000-0000-0000-000000000001', '4D', 'lower', 4, 5, 'seater'),

-- Upper Deck Sleeper Berths
    ('bs-01-U1', 'b0000000-0000-0000-0000-000000000001', 'U1', 'upper', 1, 1, 'sleeper'),
    ('bs-01-U2', 'b0000000-0000-0000-0000-000000000001', 'U2', 'upper', 1, 2, 'sleeper'),
    ('bs-01-U3', 'b0000000-0000-0000-0000-000000000001', 'U3', 'upper', 1, 4, 'sleeper'),
    ('bs-01-U4', 'b0000000-0000-0000-0000-000000000001', 'U4', 'upper', 1, 5, 'sleeper'),

    ('bs-01-U5', 'b0000000-0000-0000-0000-000000000001', 'U5', 'upper', 2, 1, 'sleeper'),
    ('bs-01-U6', 'b0000000-0000-0000-0000-000000000001', 'U6', 'upper', 2, 2, 'sleeper'),
    ('bs-01-U7', 'b0000000-0000-0000-0000-000000000001', 'U7', 'upper', 2, 4, 'sleeper'),
    ('bs-01-U8', 'b0000000-0000-0000-0000-000000000001', 'U8', 'upper', 2, 5, 'sleeper'),

    ('bs-01-U9', 'b0000000-0000-0000-0000-000000000001', 'U9', 'upper', 3, 1, 'sleeper'),
    ('bs-01-U10', 'b0000000-0000-0000-0000-000000000001', 'U10', 'upper', 3, 2, 'sleeper'),
    ('bs-01-U11', 'b0000000-0000-0000-0000-000000000001', 'U11', 'upper', 3, 4, 'sleeper'),
    ('bs-01-U12', 'b0000000-0000-0000-0000-000000000001', 'U12', 'upper', 3, 5, 'sleeper')
...
INSERT INTO schedule_seats (schedule_id, bus_seat_id, price, status) VALUES
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-1A', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-1B', 899, 'occupied'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-1C', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-1D', 899, 'available'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-2A', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-2B', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-2C', 899, 'occupied'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-2D', 899, 'occupied'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-3A', 899, 'reserved'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-3B', 899, 'reserved'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-3C', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-3D', 899, 'available'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-4A', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-4B', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-4C', 899, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-4D', 899, 'available'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U1', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U2', 1199, 'occupied'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U3', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U4', 1199, 'available'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U5', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U6', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U7', 1199, 'occupied'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U8', 1199, 'available'),

    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U9', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U10', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U11', 1199, 'available'),
    ('c0000000-0000-0000-0000-000000000001', 'bs-01-U12', 1199, 'available')
